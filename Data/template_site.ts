...
export const DEFAULT_SOCIAL_SITES = [
...

  {
    ...
    defaultIdealDurationMinutesForPosting: 22,
    defaultPostingFrequency: 3,
  },
...
export const DEFAULT_GRAPHICS_DESIGN = [
  {
    ...
    defaultIdealDurationMinutesForPosting: 90,
    defaultPostingFrequency: 0,
  },
];
...
export const DEFAULT_CONTENT_STUDIO = [
  {
    ...
    defaultIdealDurationMinutesForPosting: 190,
    defaultPostingFrequency: 0,
  },
];
...
export const DEFAULT_YOUTUBE_VIDEO_OPTIMIZATION = [
  {
    ...
    isRequired: true,
    defaultIdealDurationMinutes: 60,
    defaultIdealDurationMinutesForPosting: 60,
    defaultPostingFrequency: 0,
  },
];
