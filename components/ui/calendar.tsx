  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 data-[selected=true]:bg-accent [&.day-range-end]:rounded-r-md",
          props.mode === "range"
            ? "[&.day-range-end]:rounded-r-md [&.day-range-start]:rounded-l-md first:data-[selected=true]:rounded-l-md last:data-[selected=true]:rounded-r-md"
